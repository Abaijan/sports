        ...
        <section className="cart xl:h-[474px] w-[200px] xl:w-[315px]">
            <section
                ...
                <section className="flex w-full flex-col px-2 gap-[15px] py-1 manrope text-left">
                    <p className="text-black manrope font-medium xl:text-[24px] text-[16px]">{prop.title}</p>
                ...
                <Link href={`/catalog/${prop.id}`}>
                    <button
                        className="hover:bg-blue-700 transition duration-300 px-[33x] py-[10px] rounded-[6px] bg-[#1243C0] text-center text-[white] w-[189px] xl:w-[280px] h-[34px] xl:h-[47px] manrope">В
                        корзину
                    </button>
                </Link>
