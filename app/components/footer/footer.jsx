        ...
        <footer className="blue">
            {
                    <section  className="container flex justify-between py-10 items-center">
                        <section className="grid grid-rows-1  grid-cols-2 xl:grid-cols-6 xl:gap-16 gap-8 monrope">
                            <Link href="/">
                                <p className="text-3xl font-bold">LOGO</p>
                            </Link>

                            <section className="flex flex-col gap-2 lg:w-[300px]">
                                <p className="text-xl font-medium">{contacts.phone}</p>
                                <p className="text-xl font-medium">{contacts.phone2}</p>
                                <p className="text-xl font-medium">{contacts.phone3}</p>
                            </section>
                            ...
                            <section className="flex flex-col gap-2">
                                <Link href="/about">{locale === 'ru' ? 'О компании' : locale === 'en' ? 'About us' : 'Компания жонундо'}</Link>
