    ...
    <section className=" py-20">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 md:pl-10">
          ...
          <p className="text-gray-700 mb-10 leading-[36px]">
          ...
          <p className=' text-gray-700 mb-10 leading-[36px]'> Мы — команда, которая любит спорт и знает, что нужно для эффективных тренировок. В нашем магазине представлены лучшие спорт</p>
          <a 
            href="/about" 
